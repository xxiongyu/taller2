...
public class SandboxConjuntos
{
    ...
    {
    	NavigableSet<String> nuevoArbolCadenas = new TreeSet<>(String.CASE_INSENSITIVE_ORDER);
    ...
    {
    	 TreeSet<String> arbolInvertido = new TreeSet<>((cadena1, cadena2) -> cadena2.compareTo(cadena1));
