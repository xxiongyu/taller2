...
public class SandboxListas
{
    ...
    {
    	 int[] arregloEnteros = listaEnteros.stream().mapToInt(Integer::intValue).toArray();
    ...
    public int contarApariciones( String cadena )
    {
        ...
        for (String elemento : listaCadenas) {
            if (elemento.toLowerCase().equals(cadenaMinusculas)) {
                contador++;
            }
        }
        return contador;
    ...
    public int contarEnterosRepetidos( )
    {
        ...
        for (int i = 0; i < copiaLista.size() - 1; i++) {
            if (copiaLista.get(i).equals(copiaLista.get(i + 1))) {
                contador++;
                while (i < copiaLista.size() - 1 && copiaLista.get(i).equals(copiaLista.get(i + 1))) {
                    i++;
                }
            }
        }
